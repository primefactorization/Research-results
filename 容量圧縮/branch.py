...
#数値のリスト
numbers = [4790119654730171, 7129306115736802, 1241761912703280, 7550331089907205, 2131259906625978, 4546408705743689, 6709762437885734, 9210777554818855, 8908327805886148, 1861799899073698]
#結果を格納するリスト
results = []
execution_times = []
